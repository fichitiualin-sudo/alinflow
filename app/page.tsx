...
export default function Home() {
  ...
  return (
    <Shell>
      ...
      <section className="hidden gap-6 xl:grid xl:grid-cols-[minmax(0,2fr)_minmax(380px,0.9fr)] xl:items-start 2xl:grid-cols-[minmax(0,2.15fr)_minmax(420px,0.85fr)]">
