      ...
      <div className="mx-auto flex min-h-[80vh] max-w-md items-center">
        <div className="w-full rounded-[2rem] border border-white/10 bg-slate-900/90 p-6 shadow-2xl">
          ...
          <div className="space-y-4">
            <div><label className="mb-2 block text-sm font-black text-slate-300">Email</label><input className="input" type="email" inputMode="email" autoCapitalize="none" autoCorrect="off" spellCheck={false} value={email} onChange={(event) => onEmail(event.target.value.toLowerCase())} placeholder="email@pelda.hu" /></div>
